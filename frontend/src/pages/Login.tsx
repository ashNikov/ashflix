...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black flex items-center justify-center px-4">
      <motion.div
        className="w-full max-w-md bg-black/70 border border-red-700/40 rounded-2xl p-8 shadow-2xl shadow-red-900/40 backdrop-blur"
      ...
      >
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              className="w-full rounded-md bg-zinc-900/80 border border-zinc-700 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent transition"
          ...
          <button
            type="submit"
            className="w-full mt-2 inline-flex justify-center items-center rounded-md bg-red-600 hover:bg-red-700 transition-colors px-3 py-2 text-sm font-semibold text-white shadow-lg shadow-red-900/40 active:scale-[0.98]"
          >
            Sign In
          </button>
